...
- **gitlab-ci/** – Validates Terraform, builds Solr Docker image, Trivy scan, optional manual deploy to staging. Image from `docker/Dockerfile.solr` (Solr 9, JRE 17, non-root; see that file for IAM/entrypoint and deps).
